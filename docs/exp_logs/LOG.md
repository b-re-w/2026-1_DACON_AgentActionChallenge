...
| 2026-07-10 | others | Teacher 앙상블 대량 스크리닝(73조합 OOF argmax fold0) | qw6_baseline=0.7841, top_w6_gptoss2=0.7863, qw6+deberta(6:1)=0.7845, qw6+gptoss+deberta=0.7851, modernbert=top30밖(희석), n_combos=73 | [로그](others/2026-07-10.md) |
| 2026-07-10 | encoder_team | 이질 encoder teacher 앙상블 기여 측정 (teacher argmax, fold0 val) | m_mistral=0.6659, d_deberta=0.7264, mb_modernbert=0.5983, md_equal=0.7222, md_deberta2x=0.7339, md_deberta3x=0.7376, mdmb_equal=0.721, mdmb_d2_mb0.5=0.7333, student_m_OOF=0.7085 | [로그](encoder_team/2026-07-10.md) |
| 2026-07-11 | encoder_team | [정정] 이질 encoder teacher를 실제 앙상블(Qwen+GPT+OSS)에 편입 — argmax proxy | ALL_dec_11=0.7826, +deberta_x1=0.7836, +deberta_x3=0.7828, +modernbert=0.7825, DIVERSE6=0.7796, DIVERSE6+deberta_x2=0.7804, deberta_single=0.7264, gptoss_single=0.7829, qw6_single=0.7841 | [로그](encoder_team/2026-07-11.md) |
| 2026-07-11 | encoder_team | DeBERTa-v3-large 재학습(ep8/lr2e-5) — 개별 0.7267→0.7415, 앙상블 기여 2배 | oof_new=0.7415, oof_old=0.7267, acc=0.7479, train_argmax=0.7763, ens_base_ALLdec11=0.7826, ens_+old_x1=0.7836, ens_+new_x1=0.7843, ens_+new_x2=0.7846, ens_+new_x3=0.7844, delta_old=0.0011, delta_new=0.002 | [로그](encoder_team/2026-07-11.md) |
| 2026-07-11 | others | LB0.80 캠페인 1차 — 믹싱 6종 세션분할 검증 + bias재증류 기각 + 큐 재편 | hillclimb_heldout=-0.0023, weight_opt_heldout=-0.0017, scale_calib=0.0, prior_blend=0.0, group_weight_expl4=0.0005, bias_redistill_heldout=-0.0023, clean9_argmax_fullval=0.7873 | [로그](others/2026-07-11.md) |
| 2026-07-12 | encoder_team | 🔥 student KD 검증 — qw6:6+debertaL2:1 = OOF 0.7863, 팀 최고 갱신(+0.0016) | q_w6d1_qw6_6_deberta_1=0.7863, anchor_qw6_all640=0.7847, q_base_CLEAN9=0.7844, q_topgptoss2=0.7829, q_w6d2_3to1=0.7835, q_w6ossd=0.7838 | [로그](encoder_team/2026-07-12.md) |
| 2026-07-12 | encoder_team | ModernBERT-large 재학습(lr5e-5/ep8) → 0.6464 — teacher 재료 폐기 확정 | oof_retrain=0.6464, oof_first=0.5977, delta=0.0487, gemma9b_ref=0.7624, deberta_ref=0.7415 | [로그](encoder_team/2026-07-12.md) |
| 2026-07-12 | others | mega 가중 그리드 CPU 스크리닝(74조합, 세션분할 일관성 필터) — 1위 trio+GLM:0.25 단독 | pass_consistency=6/74, top1_glm025_min=0.0008, top2_glm025_deb025_min=0.0004, trio_argmax_full=0.78729, deb_only_025=비일관(+0.0011/-0.0003) | [로그](others/2026-07-12.md) |
| 2026-07-12 | encoder_team | trio+DeBERTa 고가중 분담(:1/:1.5) — :1.5 가 fold0 +0.0011 (비단조, fold1 검증 대기) | t15_deberta15=0.78315, t10_deberta10=0.78177, trio_base_f0=0.78205, ref_gem05=0.78388, ref_glm05=0.78331 | [로그](encoder_team/2026-07-12.md) |
| 2026-07-13 | encoder_team | rich 직렬화(+[TRAIL]) — 인코더 3종 전부 +0.05~0.08, qdebertaL 강화 후보 | xlmr=0.6954→0.7496, mdeberta=0.6937→0.7555, klue=0.6681→0.7478, debertaL_rich=0.7583, prompt_only=0.4484, focal<ce | [로그](encoder_team/2026-07-13.md) · [코드](../../contrib/encoder_rich/) |
