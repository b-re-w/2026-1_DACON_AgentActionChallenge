...
def serialize(sample, max_history_turns=12, prompt_limit=512, history_text_limit=160,
              include_cues=False, open_files_names=0, include_trail=False, trail_k=5, trail_fail=False, include_nopen=False, include_lastres=False, meta_lean=False):
...
def main():
    ...
    include_trail = serialize_mode in ("btrail", "btrail3", "btrail8", "bthist", "btrailf", "btrailn", "btrailr", "btrim")
    ...
    meta_lean = serialize_mode == "btrim"
    ...
    texts = [serialize(s, prompt_limit=max_length, include_cues=include_cues,
                       open_files_names=open_files_names, include_trail=include_trail, trail_k=trail_k, trail_fail=trail_fail, include_nopen=inc_nopen, include_lastres=inc_lastres, meta_lean=meta_lean,
